        ...
        <div style={{
          ...
          <div style={{ background: "rgba(6,12,22,0.85)", border: "1px solid rgba(200,160,30,0.2)", borderRadius: 20, padding: 32, backdropFilter: "blur(10px)" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 20 }}>
              ...
              >
                <svg width="18" height="22" viewBox="0 0 170 200" xmlns="http://www.w3.org/2000/svg" fill="#ffffff">
                  <path d="M150.4 71.4c-1.4 1-25.1 14.4-25.1 44.2 0 34.4 30.2 46.6 31.1 46.9-.1.7-4.8 16.7-15.9 32.9-9.9 14.3-20.3 28.6-36.1 28.6s-19.8-9.2-38-9.2c-17.6 0-24.1 9.5-38.5 9.5s-24.4-13.4-36.1-29.6C-18.2 76.5-27.3 42-27.3 10.2c0-23.1 15.7-35.6 30.9-35.6 14.7 0 25.3 10.2 34.2 10.2 8.5 0 21.7-10.7 38.1-10.7 6.1 0 25.1.6 37.6 22.8zM104 -17.2c7.2-8.6 12.3-20.4 12.3-32.3 0-1.6-.1-3.3-.4-4.7-11.7.4-25.7 7.8-34.1 17.6-6.6 7.5-12.8 19.4-12.8 31.4 0 1.8.3 3.6.4 4.2.7.1 1.9.3 3.2.3 10.5 0 23.8-7.1 31.4-16.5z" transform="translate(30, 40)"/>
                </svg>
                Continue with Apple
              </button>
            </div>
