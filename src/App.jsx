        ...
        <div style={{
          ...
          <div style={{ background: "rgba(6,12,22,0.85)", border: "1px solid rgba(200,160,30,0.2)", borderRadius: 20, padding: 32, backdropFilter: "blur(10px)" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 20 }}>
              ...
              >
                <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg" fill="#f5e4b0">
                  <path d="M12.79 15.21c-.74.71-1.54.66-2.31.3-.82-.38-1.56-.36-2.43 0-1.08.47-1.65.33-2.3-.3C2.09 11.44 2.63 5.69 6.79 5.48c1.01.05 1.72.56 2.31.6.89-.18 1.73-.7 2.68-.63 1.13.09 1.99.54 2.55 1.35-2.34 1.4-1.79 4.49.36 5.35-.43 1.13-.98 2.24-1.91 3.07zM9.02 5.44c-.11-1.67 1.25-3.05 2.81-3.19.22 1.94-1.76 3.38-2.81 3.19z"/>
                </svg>
                Continue with Apple
              </button>
            </div>
