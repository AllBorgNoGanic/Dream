...
export default function DreamCard({ dream, isSelected, onSelect, onDelete, onTogglePublic, onInterpret, interpreting, onViewReading }) {
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 10, paddingRight: 36 }}>
        <div style={{ flex: 1 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 4, flexWrap: "wrap" }}>
            ...
            {dream.is_public && (
              <span title="Shared with the community" style={{
                background: "rgba(100,200,120,0.1)", border: "1px solid rgba(100,200,120,0.3)",
                borderRadius: 12, padding: "2px 8px", fontSize: 10, color: "#7ac88a",
                letterSpacing: 0.5,
              }}>
                🌐 Shared
              </span>
      ...
      {/* Share confirmation popover (triggered from the action sheet) */}
      {showShareConfirm && !dream.is_public && onTogglePublic && (
